...
singularity exec -e -B /cbica/projects/pncitc  \
/cbica/projects/pncitc/cwasmdmr.simg \
/usr/local/bin/Rscript /usr/local/bin/connectir_mdmr.R -i /cbica/projects/pncitc/ignore/cwas293logkbysex -f 'logk*sex+age+relMeanRMSmotion' -m /cbica/projects/pncitc/samplerecreation/n293_demographics.csv --factors2perm='logk' --save-perms -c 5 -t 5  --ignoreprocerror --memlimit=300 logk_motion_sex_age
...
singularity exec -e -B /cbica/projects/pncitc  \
/cbica/projects/pncitc/cwasmdmr.simg \
/usr/local/bin/Rscript /usr/local/bin/connectir_mdmr.R -i /cbica/projects/pncitc/ignore/cwas293logkbyage -f 'logk*age+sex+relMeanRMSmotion' -m /cbica/projects/pncitc/samplerecreation/n293_demographics.csv --factors2perm='logk' --save-perms -c 5 -t 5  --ignoreprocerror --memlimit=300 logk_motion_sex_age
```
3. For clustering, I created two directories: `cluster_output_logkbyage` and `cluster_output_logkbysex`. The scripts I used for clustering were as below: 
```
# for sex
#!/bin/bash # NO NEED TO QSUB
dir=/cbica/projects/pncitc
bash grf_fslcluster.sh -i ${dir}/ignore/cwas293logkbysex/logk_motion_sex_age/zstats_logk.nii.gz  -m ${dir}/ignore/cwas293logkbysex/mask.nii.gz -t 3.09 -o ${dir}/ignore/cluster_output_logkbysex

#for age
#!/bin/bash # NO NEED TO QSUB
dir=/cbica/projects/pncitc
bash grf_fslcluster.sh -i ${dir}/ignore/cwas293logkbyage/logk_motion_sex_age/zstats_logk.nii.gz  -m ${dir}/ignore/cwas293logkbyage/mask.nii.gz -t 3.09 -o ${dir}/ignore/cluster_output_logkbyage
```
...
### Analyzing the interaction cluster
 ...
 I re-ran the seed-correlation and regression steps as above.
...
cd /cbica/projects/pncitc/ignore
XCPEDIR=xcpEngine
seedpoint1=/cbica/projects/pncitc/ignore/cluster_output_logkbysex/cluster_Z3.09/mask1/mask1_2mm.nii.gz

bblid=/cbica/projects/pncitc/demographics/n293_bblid_scandid.csv
image=/cbica/projects/pncitc/subjectData/rest293/
outputdir=/cbica/projects/pncitc/ignore/seedcorrmapslogkbysex
