...
6. Finally, I repeated step 4 for the insets we generated in the previous part of the .md for uniformity in appearance of figures. Note you can use `https://www.remove.bg/upload` to remove black backgrounds. 
